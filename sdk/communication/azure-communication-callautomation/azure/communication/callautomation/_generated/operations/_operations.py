...
def build_call_connection_get_call_request(
...
def build_call_media_play_request(
    call_connection_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_call_media_recognize_request(
    call_connection_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_call_media_send_dtmf_tones_request(
    call_connection_id: str,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class CallConnectionOperations: 
    ...
    def get_participants(
        ...
        call_connection_id: str,
        **kwargs: Any
    ) -> Iterable["_models.CallParticipant"]:
