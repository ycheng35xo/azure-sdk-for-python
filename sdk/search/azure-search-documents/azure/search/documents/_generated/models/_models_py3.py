...
class QueryResultDocumentSemanticField(_serialization.Model):
    ...
    :vartype state: str or ~azure.search.documents.models.QueryResultDocumentSemanticFieldState
    """
...
class SearchDocumentsResult(_serialization.Model):
    ...
    :vartype semantic_partial_response_reason: str or
     ~azure.search.documents.models.SemanticPartialResponseReason
    ...
    :vartype semantic_partial_response_type: str or
     ~azure.search.documents.models.SemanticPartialResponseType
...
class SearchOptions(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype semantic_error_handling: str or ~azure.search.documents.models.SemanticErrorHandling
...
class SearchRequest(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype vector: ~azure.search.documents.models.Vector
    :ivar vectors: The query parameters for multi-vector search queries.
    :vartype vectors: list[~azure.search.documents.models.Vector]
    """
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :paramtype vector: ~azure.search.documents.models.Vector
        :keyword vectors: The query parameters for multi-vector search queries.
        :paramtype vectors: list[~azure.search.documents.models.Vector]
        """
        super().__init__(**kwargs)
        self.include_total_result_count = include_total_result_count
        self.facets = facets
