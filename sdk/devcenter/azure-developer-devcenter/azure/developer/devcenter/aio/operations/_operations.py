...
class DeploymentEnvironmentsOperations:
    ...
    @distributed_trace
    def list_all_environments(self, project_name: str, *, top: int, **kwargs: Any) -> AsyncIterable[JSON]:
    ...
    @distributed_trace
    def list_environments(self, project_name: str, user_id: str, *, top: int, **kwargs: Any) -> AsyncIterable[JSON]:
    ...
    @distributed_trace
    def list_catalogs(self, project_name: str, *, top: int, **kwargs: Any) -> AsyncIterable[JSON]:
    ...
    @distributed_trace
    def list_environment_definitions(self, project_name: str, *, top: int, **kwargs: Any) -> AsyncIterable[JSON]:
    ...
    @distributed_trace
    def list_environment_types(self, project_name: str, *, top: int, **kwargs: Any) -> AsyncIterable[JSON]:
