...
def build_dev_boxes_delay_action_request(
    ...
    **kwargs: Any
    ...
    # Construct parameters
    _params["api-version"] = _SERIALIZER.query("api_version", api_version, "str")
    _params["delayUntil"] = _SERIALIZER.query("delay_until", delay_until, "iso-8601")
...
class DeploymentEnvironmentsOperations:
    ...
    @distributed_trace
    def list_all_environments(self, project_name: str, *, top: int, **kwargs: Any) -> Iterable[JSON]:
    ...
    @distributed_trace
    def list_environments(self, project_name: str, user_id: str, *, top: int, **kwargs: Any) -> Iterable[JSON]:
    ...
    @distributed_trace
    def list_catalogs(self, project_name: str, *, top: int, **kwargs: Any) -> Iterable[JSON]:
    ...
    @distributed_trace
    def list_environment_definitions(self, project_name: str, *, top: int, **kwargs: Any) -> Iterable[JSON]:
    ...
    @distributed_trace
    def list_environment_types(self, project_name: str, *, top: int, **kwargs: Any) -> Iterable[JSON]:
